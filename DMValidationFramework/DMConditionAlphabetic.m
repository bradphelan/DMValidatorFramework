...
#import "DMConditionAlphabetic.h"


@implementation DMConditionAlphabetic
...
{
    return NSLocalizedString(@"DMKeyConditionViolationAlphabetic", nil);
}
